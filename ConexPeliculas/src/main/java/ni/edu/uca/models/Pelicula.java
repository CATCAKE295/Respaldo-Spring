...
public class Pelicula {
	...
	public String toString() {
		return "Pelicula [idPelicula=" + idPelicula + ", titulo=" + titulo + ", tipoMetraje=" + tipoMetraje
				+ ", nacionalidad=" + nacionalidad + ", clasificacion=" + clasificacion + ", duracion=" + duracion
				+ ", sinopsis=" + sinopsis + "]";
	}
